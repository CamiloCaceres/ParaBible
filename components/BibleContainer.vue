...
<template>
  ...
  <button class="my-5 rounded-full p-2 bg-green-500 text-green-700 dark:text-green-100 dark:bg-green-600 shdow-lg hover:bg-green-400 hover:text-green-600 transition transform hover:rotate-180">
